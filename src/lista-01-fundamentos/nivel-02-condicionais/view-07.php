<?php
$titulo_pagina = "Exercício 07 - Verificador de Paridade";
...
<?php if (!$exibir_resultado): ?>
    ...
    <form action="" method="POST" class="form-container">
        ...
        <button type="submit" class="btn-primary">Verificar Paridade</button>
    </form>
